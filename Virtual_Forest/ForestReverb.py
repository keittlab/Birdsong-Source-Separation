...
# import pi and soundVel from Constants.py which is in the same directory as this file not the working directory.
...
def simulateForestIR(
        nTrees=100000, posSrc=np.array([500,500,1.5]), micPoss=np.array([510,500,1.5]).reshape([1,3]), fs=22050, sigLen_in_samples=22050*5, forestRange_x=None, forestRange_y=None, reflectionCoef=2.0,
...
def generateSampleForestIR(numTrees=100000):
